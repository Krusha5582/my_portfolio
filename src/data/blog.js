export const blogPosts = [
  {
    ...
    excerpt: "How we conceptualized an IoT-enabled fridge with autonomous movement, voice commands, and smart usage alerts.",
    slug: "smart-refrigerator-ssip-ideation-competition",
    color: "bg-pastelPurple/40",
    category: "iot",
    severity: "SEV-3",
    systemType: "IoT / Robotics",
    impact: "Prototype mobility failure",
    role: "Concept Engineer",
    duration: "Ideation Phase",
    tension: "MOBILITY FAILURE",
    failureHook: "Autonomous navigation failed under real-world physics constraints.",
    content: `
## Incident Context
...
**Key Failure Modes:**
- Battery life insufficient for simultaneous cooling + mobility
- Household terrain pathfinding complexity underestimated  
- Mechanical complexity (wheels + refrigeration unit) → structural risk
- Voice recognition unreliable in kitchen noise environment
...
**Tradeoff Summary:** Database alerts viable. Mobility/summoning mechanism impractical without 10x battery density improvement.
    `
  },
  {
    title: "AquaAI: Data Center Cooling Optimization",
    excerpt: "Exploring Transformer-GRU predictive models for water optimization in cooling data centers.",
    slug: "my-data-science-journey",
    color: "bg-pastelPink/40",
    category: "ml",
    severity: "SEV-2",
    systemType: "ML / Sustainability",
    impact: "Model prediction drift",
    role: "ML Engineer",
    duration: "Research Phase",
    tension: "MODEL COLLAPSE",
    failureHook: "Production predictions drifted 40% from training benchmarks under sensor noise.",
    content: `
## Incident Context
...
Based on today's readings, 2 key points are highlighted. Firstly, as demonstrated by Ma et al., predictive AI control can give immediate operational savings but it's impact is limited by the parameters taken into consideration. Secondly, Lei et al. provides a strategic foundation for mechanisms for rea-time implementation. Combining both of the methodologies, stretegic and determinant analysis with operational AI optimization- portrays a convincing route for holistic, scalable water efficiency solutions in the data center sector.
  ...
  },
  {
    ...
    excerpt: "Building an AI-driven platform to streamline civic services and enhance urban governance.",
    slug: "importance-of-aesthetic-ui",
    color: "bg-icyCyan/40",
    category: "systems",
    severity: "SEV-1",
    systemType: "Civic Platform / Production",
    impact: "Latency cascade across services",
    role: "Lead Systems Engineer",
    duration: "72 hours degradation",
    tension: "PLATFORM COLLAPSE",
    failureHook: "Polling architecture failed under monsoon peak load across 150+ waterlogging zones.",
    content: `
## Incident Context
