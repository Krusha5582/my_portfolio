...
export default function Certifications() {
  ...
  // CATEGORY → ICON
  const categoryIcons = {
    technical:     <Cpu className="w-7 h-7 text-icyCyan" />,
    leadership:    <Star className="w-7 h-7 text-lavender" />,
    volunteering:  <Globe2 className="w-7 h-7 text-neonLilac" />,
    specialization:<BookOpen className="w-7 h-7 text-pastelPink" />,
  };

  const sorted = [...certifications].sort((a, b) => b.year - a.year);

  return (
    <section className="w-full py-20 md:py-24 bg-theme text-theme relative overflow-hidden">
            ...
            <div key={index} className="relative group">
              ...
              <div
                className="
                  ...
                  bg-card border border-card shadow-lg
              ...
              >
                ...
                <div
                  className="
                    ...
                    rounded-full bg-gradient-to-br from-lavender/25 to-icyCyan/25
                    border border-card backdrop-blur-lg
                  "
                >
